...
def main():
 ...
 edge_model=EDGE_MODEL.read_text(encoding="utf-8"); edge_js=EDGE_JS.read_text(encoding="utf-8"); edge_css=EDGE_CSS.read_text(encoding="utf-8")
 ...
 for path,limit in {CURRENT:200000,REGISTRY:500000,ACTIVE:180000,CROSS:180000,WC/"cot-intelligence.js":60000,WC/"cot-intelligence.css":45000,LIGHT_CSS:20000,EDGE_MODEL:12000,EDGE_JS:24000,EDGE_CSS:18000}.items(): assert path.stat().st_size<=limit,(path,path.stat().st_size,limit)
