#!/usr/bin/env python3
"""Run governed raw-position/OI predictive research on strict release-corrected events."""
...
def stamp(path):
    ...
    if isinstance(payload,dict):
        ...
        payload["strict_release_alignment"]=True
...
def main():
    ...
    print("Raw position/OI predictive-power strict v2 complete")
