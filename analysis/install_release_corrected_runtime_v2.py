...
def main()->None:
    ...
    # Frozen continuous evidence and compact registry become canonical browser data.
    ...
    # Active/current builders need frozen threshold inference and actor-event metrics.
    ...
    try:
        ...
        # Full research stays in the immutable snapshot; do not ship duplicate uncompressed research to Pages.
