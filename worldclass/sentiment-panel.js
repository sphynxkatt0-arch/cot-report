(() => {
  ...
  function ensureRoot() {
    ...
    if (root) return root;
    const anchor = document.getElementById("macroColumns")
      || document.getElementById("macroCards")
      || document.getElementById("currentEdgeCommand")
      || document.getElementById("headlineCards");
